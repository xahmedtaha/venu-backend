...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red-sunglo bold uppercase">اضافة مكان</span>
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <form action="{{route('city.store')}}" class="form-horizontal" method="POST">
            <div class="form-body">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select  name="place_id" required class="form-control select2">
                            @foreach ($places as $place)
                                <option {{$place == $selectedPlace?'selected':''}} value="{{$place->id}}">
                                    {{$place->display_name}}
                                </option>
                            @endforeach
                        </select>
