...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-red-sunglo bold uppercase">تعديل مكان</span>
        ...
        <form action="{{route('city.update',$city->id)}}" method="POST" class="form-horizontal">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" disabled  required value="{{$city->place->display_name}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        @enderror
                        <input type="text" name="name_ar" required value="{{$city->name_ar}}" class="form-control" placeholder="الاسم بالعربية">
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="name_en" value="{{$city->name_en}}" class="form-control" placeholder="الاسم بالانجيليزية">
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
