...
<div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">اضافة مجموعة مستخدمين جديدة</span>
                ...
                <div class="form-body">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-11">
                            ...
                            @enderror
                            <input type="text" required name="name" class="form-control" placeholder="اسم المجموعة">
