            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        @enderror
                        <input type="text" name="name_ar" required value="{{$category->name_ar}}" class="form-control" placeholder="الاسم بالعربية">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="name_en" value="{{$category->name_en}}" class="form-control" placeholder="الاسم بالانجيليزية">
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
