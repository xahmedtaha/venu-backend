...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        ...
        @endif
        <form action="{{route('products.update',$product->id)}}" enctype="multipart/form-data" class="form-horizontal" method="POST">
            <div class="form-body">
                {{ csrf_field() }}
                @method('PUT')
                    ...
                    <div class="col-md-4">
                        <select name="resturant_id" required class="form-control select2" id="">
                            @foreach ($resturants as $resturant)
                                <option {{$product->resturant->id==$resturant->id?'selected':''}} value="{{$resturant->id}}">{{$resturant->display_name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input value="{{$product->name_ar}}" type="text" name="name_ar" required class="form-control" placeholder="الاسم بالعربية">
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" value="{{$product->name_en}}" name="name_en" class="form-control" placeholder="الاسم بالانجيليزية">
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" value="{{$product->price_before}}" step=".01" name="price_before" class="form-control" placeholder="السعر">
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <textarea name="description_ar"  class="form-control" id="" cols="30" rows="10">{{$product->description_ar}}</textarea>
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <textarea name="description_en"  class="form-control" id="" cols="30" rows="10">{{$product->description_en}}</textarea>
                        {{-- <span class="help-block"> A block of help text. </span> --}}
                    </div>
                </div>
                <div class="form-group">
